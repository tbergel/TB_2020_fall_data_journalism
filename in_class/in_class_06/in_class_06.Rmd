...
```{r}
state_covid_cases_per_pop <- state_covid_population %>%
  mutate(cases_per1k = total_cases/population*1000)%>%
  arrange(desc(cases_per1k))
  
state_covid_cases_per_pop
...
```{r}
state_covid_deaths_per_pop <- state_covid_population %>%
  mutate(deaths_per1k = total_deaths/population*1000)%>%
  arrange(deaths_per1k)
  
state_covid_deaths_per_pop
