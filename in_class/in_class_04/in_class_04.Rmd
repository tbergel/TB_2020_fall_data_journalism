...
* Q: What was the highest heat index value measured in Michael's house? On what day did it occur? 114.6 on 7/17/2019
* Q: The heat index never fell below what value during the period we measured? 96.0
* Q: What was the average heat index value on each day during the period measured? 7/16 was 99.8, 7/17 was 104.0, 7/18 was 105.5, 7/19 was 107.8, 7/20 was 108.9
* Q: Is there anything concerning the number of hourly readings on each day that could affect the results you're getting? The average heat on 7/20 was the highest average over the five days, but there were only 17 observations on that day as opposed to every other day when there were 24 taken, so those missing few observations could change what the average would really be.
